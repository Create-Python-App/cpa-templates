...
from mlops_tensorflow.pipeline.base import StepContext
from mlops_tensorflow.pipeline.steps_registry import STEP_REGISTRY
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Run the TensorFlow MLOps pipeline")
