...
from mlops_pytorch.pipeline.base import StepContext
from mlops_pytorch.pipeline.steps_registry import STEP_REGISTRY
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Run the PyTorch MLOps pipeline")
